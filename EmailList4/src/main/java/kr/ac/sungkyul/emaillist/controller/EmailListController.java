...
public class EmailListController {
	...
	/*
	 * @RequestMapping("/list") public ModelAndView list() { List<EmailListVo>
	 * list = dao.getList(); ModelAndView mav = new ModelAndView();
	 * mav.addObject("list", list); mav.setViewName("/WEB-INF/views/list.jsp");
